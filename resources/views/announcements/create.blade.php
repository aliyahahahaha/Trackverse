                ...
                <div class="p-8 gap-6">
                    <form action="{{ route('announcements.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="w-full">
                            <label class="block font-bold text-gray-700 pb-2" for="title">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-sm uppercase tracking-wide">Title</span>
                                </div>
                            </label>
                            ...
                            <div class="w-full">
                                <label class="block font-bold text-gray-700 pb-2" for="content">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm uppercase tracking-wide">Content</span>
                                    </div>
                                </label>
                                ...
                                <div class="relative group">
                                    <select name="type" id="type"
                                        ...
                                        <option value="warning" {{ old('type') == 'warning' ? 'selected' : '' }}>🟡
                                            Warning</option>
                                        <option value="error" {{ old('type') == 'error' ? 'selected' : '' }}>🔴 Critical
                                            Error</option>
                                    </select>
                                    <div
                        ...
                        <div class="w-full">
                            <label class="block font-bold text-gray-700 pb-2" for="image">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-sm uppercase tracking-wide">Banner Image</span>
                                </div>
                            </label>

                            {{-- Dropzone Container --}}
                            <div id="dropzone-container" style="height: 208px;"
                                class="relative w-full h-52 rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-emerald-50/50 hover:border-emerald-500 transition-all cursor-pointer group overflow-hidden">
                                ...
                                <div id="upload-placeholder"
                                    class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-10 p-4 text-center transition-opacity duration-300">
                                    <div
                                ...
                                {{-- Live Preview State --}}
                                <div id="image-preview" class="hidden absolute inset-0 z-20 bg-gray-100">
                        ...
                        <div class="flex items-center justify-end gap-6 pt-6 mt-6 border-t border-gray-100">
                            ...
                            <button type="submit"
                                class="btn btn-primary shadow-lg shadow-primary/20 rounded-lg px-8 h-12 font-bold text-white flex items-center gap-2 hover:-translate-y-0.5 transition-transform">
